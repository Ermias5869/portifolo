...
function Footer() {
  return (
    <div className="flex justify-center items-center mt-20">
      <div>
        <h2 className="underline text-xl text-center my-5 font-semibold text-blue-500">
          202 made By Ermias
        </h2>
        <p className="text-center hover:text-blue-500 selection:bg-blue-500 text-sm mx-5 w-[90%] m-auto lg:w-[60%] text-blue-500 selection:text-black text-balance justify-center lg:mx-auto">
          ...
          need help with development, or just want to connect and chat about
          technology, feel free to reach out. You can email me at
          <span className="underline font-bold px-2">
            ermiasamare58@gmail.com.
          </span>{" "}
          or connect with me on telegram{" "}
          <span className="underline font-bold px-2">@ermi5869.</span>
          Let&apos;s collaborate and create something amazing together!
        </p>
        <h2 className="underline text-sm text-center my-10 font-semibold text-blue-500">
          2024 made By Ermias
        </h2>
      </div>
    </div>
