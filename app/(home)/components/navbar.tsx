  ...
  return (
    <div className=" flex justify-center p-5 pt-10">
      <div className=" flex flex-col ">
        <Image
          className="h-[150px] w-[150px] mt-14 mx-auto rounded-md mb-5 hover:grayscale-0 -translate-y-4 hover:transition-all hover:-rotate-6"
          alt="Ermias Amare profile picture"
          src="/profile.png" // <-- absolute path from public/
